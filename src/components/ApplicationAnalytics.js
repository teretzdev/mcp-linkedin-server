...
const ApplicationAnalytics = () => {
  ...
  const exportAnalytics = () => {
    const csvContent = [
      ...
      ['Average Applications/Day', metrics.averageApplicationsPerDay.toFixed(2)],
      ['', ''],
      ['Status Breakdown', ''],
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{metrics.averageApplicationsPerDay.toFixed(1)}</p>
            </div>
          </div>
        </div>
      </div>
